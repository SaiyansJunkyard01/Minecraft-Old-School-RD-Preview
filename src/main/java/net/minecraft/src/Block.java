...
public class Block {
	...
	public static final Block brickOvenIdle = (new BlockBrickFurnace(99, false)).setHardness(3.5F).setStepSound(soundStoneFootstep).setBlockName("brickfurnace").disableNeighborNotifyOnMetadataChange();
	public static final Block brickOvenActive = (new BlockBrickFurnace(100, true)).setHardness(3.5F).setStepSound(soundStoneFootstep).setLightValue(14.0F / 16.0F).setBlockName("brickfurnace").disableNeighborNotifyOnMetadataChange();
